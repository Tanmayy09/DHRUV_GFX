...
<!-- navbar section -->
	<section id="home" class="nav-bar">
        <nav class="navbar navbar-expand-lg navbar-light" style="box-shadow: 0 4px 4px 0 rgba(0,0,0,0.4);">
            <div class="container">
              <a class="navbar-brand aa" href="portHTML.html"><span class="dhruv">Dhruv</span> GFX</a>
                ...
                <div class="modal-body">
                    <form class="fom" >
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control" name="Uphone" id="exampleInputPassword1" required>
                            <div id="numberHelp" class="form-text text-muted">Make sure that entered number is link with Telegram.</div>
                        </div>
                        <div class="form-floating">
                            <label for="floatingTextarea">Comments</label>
                            <textarea class="form-control" placeholder="Leave a comment here" name="Utext" id="floatingTextarea" required></textarea>
                        </div>
